...
* [ ] Le rapport d'évaluation des algorithmes (e.g., jupyter, asciidoc ou PDF) *retrouvable* https://github.com/IUT-Blagnac/sae2-02-Tilian-HURE/blob/main/rapport/Rapport%20_de_comparaison.adoc[ici]. Pour chaque catégorie, vous devrez désigner qui est 1er, 2ème, 3ème, ... (avec possibilité d’ex-aequo si le hasard vous a attribué des algos similaires). Il doit se trouver dans le répertoire `rapport` de votre dépôt.
...
- https://www.codacy.com/[Codacy] pour l'analyse qualitative de programmes
