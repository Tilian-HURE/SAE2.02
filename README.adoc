...
Les pré-requis nécessaires pour l'analyse de chaque solutions sont indiqués dans ce https://github.com/IUT-Blagnac/sae2-02-Tilian-HURE/blob/main/rapport/Rapport%20_de_comparaison.adoc[rapport de comparaison].
