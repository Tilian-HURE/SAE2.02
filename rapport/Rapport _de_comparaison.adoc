...
==== Prérequis
[.text.justify]
Votre IDE doit être paramétré avec au minimum une JDK version 18. +
 +
...
*NOTATION*
|===
|*+4* points|*_4e (et dernier) meilleur algorithme* de la catégorie (qualité moyenne, assez lisible)._
|[red]#*-1* points#|_L’algo ne passe pas tous les tests fournis._
